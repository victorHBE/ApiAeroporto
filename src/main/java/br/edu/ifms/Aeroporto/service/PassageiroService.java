...
import br.edu.ifms.Aeroporto.service.execption.DataIntegrityException;
...
public class PassageiroService {
	...
	public Passageiro buscarPorId(Integer id) {
		...
		return obj.orElseThrow(() -> new ObjectNotFoundException( 
				 "Objeto não encontrado! Id: " + id + ", Tipo: " + Passageiro.class.getName(), null));//ARRUMAR O NULL		
	}
	...
	public Passageiro fromDto(PassageiroDto objDto) {
		return new Passageiro(objDto.getId(), objDto.getNome(), objDto.getCpf());
	}
